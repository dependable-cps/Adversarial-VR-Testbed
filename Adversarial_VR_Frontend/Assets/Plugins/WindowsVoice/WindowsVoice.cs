...
public class WindowsVoice : MonoBehaviour
{
    ...
    private static async void Speak(string msg)
    {
    ...
    private static async Task ProcessQueue()
    {
        while (speechQueue.Count > 0)
        {
            ...
            // Estimate speech duration dynamically (Assuming 2.5 words/sec)
            int estimatedDuration = (int)(msg.Split(' ').Length / 2.5f * 1000);
